...
//Filling the database with some data
            ...
            interestRepository.save(new Interest(2, "Ik zou graag meer willen leren over Go", "Go","solthof"));
            ...
            categoryRepository.save(new Category(2, "PHP"));
            categoryRepository.save(new Category(2, "werkmethode"));
